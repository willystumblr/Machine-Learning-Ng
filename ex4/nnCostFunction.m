...
a1 = [ones(m, 1), X]; %1열이 모두 1인 matix (bias term)
z2 = a1 * Theta1'; 
a2 = sigmoid(z2);
a2 = [ones(m, 1), a2];
z3 = a2 * Theta2';
...
%repmat()
%argument: (array 또는 숫자, row의 개수, column의 개수)
J = (-1 / m) * sum(sum(y.*log(a3) + (1 - y).*log(1 - a3)));


regTheta1 =  Theta1(:,2:end); % 초항 제외
...
%Los theta_grad son El Dij del Backpropagation algorithm
